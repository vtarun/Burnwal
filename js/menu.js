Teja.controller('MenuController', function($scope){
	$scope.breakfast= [ {'name':'Dosa',
							'price':60,
							'image':'images/bf-1.jpg'
						},
						{'name':'Idli',
							'price':40,
							'image':'images/bf-2.jpg'
						},
						...
						{'name':'Dosa','price':60,'image':'images/bf-1.jpg'},
